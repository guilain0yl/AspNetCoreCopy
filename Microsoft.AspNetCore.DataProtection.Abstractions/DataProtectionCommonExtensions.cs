    ...
    public static class DataProtectionCommonExtensions
    {
        ...
        public static IDataProtector CreateProtector(this IDataProtectionProvider provider, IEnumerable<string> purposes)
        {
            ...
            foreach (string purpose in purposes)
            {
                if (purpose == null)
                {
                    throw new ArgumentException("The purposes collection cannot be null or empty and cannot contain null elements.", nameof(purposes));
                }
        ...
        public static IDataProtectionProvider GetDataProtectionProvider(this IServiceProvider services)
        {
            ...
            if (provider == null)
            {
                throw new InvalidOperationException($"No service for type '{typeof(IDataProtectionProvider).FullName}' has been registered.");
            }
            return provider;
        }
