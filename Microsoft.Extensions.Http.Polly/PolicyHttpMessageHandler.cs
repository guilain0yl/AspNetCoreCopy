...
namespace Microsoft.Extensions.Http
{
    ...
    public class PolicyHttpMessageHandler : DelegatingHandler
    {
        ...
        private IAsyncPolicy<HttpResponseMessage> SelectPolicy(HttpRequestMessage request)
        {
            ...
            if (policy == null)
            {
                var message = $"The '{"policySelector"}' function must return a non-null policy instance. To create a policy that takes no action, use '{"Policy.NoOpAsync<HttpResponseMessage>()"}'."; 
