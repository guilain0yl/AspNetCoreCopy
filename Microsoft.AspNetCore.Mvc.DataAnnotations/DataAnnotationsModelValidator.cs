...
namespace Microsoft.AspNetCore.Mvc.DataAnnotations
{
    ...
    internal class DataAnnotationsModelValidator : IModelValidator
    {
        ...
        public IEnumerable<ModelValidationResult> Validate(ModelValidationContext validationContext)
        {
            ...
            {
                throw new ArgumentException($"The '{nameof(validationContext.ModelMetadata)}' property of '{typeof(ModelValidationContext)}' must not be null.",
                    nameof(validationContext));
            }
            if (validationContext.MetadataProvider == null)
            {
                throw new ArgumentException($"The '{nameof(validationContext.MetadataProvider)}' property of '{typeof(ModelValidationContext)}' must not be null.",
                    nameof(validationContext));
            }
