...
namespace Microsoft.Extensions.Configuration
{
    ...
    public static class UserSecretsConfigurationExtensions
    {
        ...
        public static IConfigurationBuilder AddUserSecrets(this IConfigurationBuilder configuration, Assembly assembly, bool optional, bool reloadOnChange)
        {
            ...
            if (!optional)
            {
                throw new InvalidOperationException($"Could not find 'UserSecretsIdAttribute' on assembly '{assembly.GetName().Name}'.Check that the project for '{assembly.GetName().Name}' has set the 'UserSecretsId' build property.If the 'UserSecretsId' property is already set then add a reference to the Microsoft.Extensions.Configuration.UserSecrets package.");
            }
