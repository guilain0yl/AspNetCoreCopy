...
namespace Microsoft.Extensions.Configuration.UserSecrets
{
    ...
    public class PathHelper
    {
        ...
        public static string GetSecretsPathFromSecretsId(string userSecretsId)
        {
            ...
            {
                throw new ArgumentException($"Value cannot be null or an empty string.", nameof(userSecretsId));
            }
            ...
            if (badCharIndex != -1)
            {
                throw new InvalidOperationException(
                    string.Format($"Invalid character '{userSecretsId[badCharIndex]}' found in the user secrets ID at index '{badCharIndex}'."));
            }
