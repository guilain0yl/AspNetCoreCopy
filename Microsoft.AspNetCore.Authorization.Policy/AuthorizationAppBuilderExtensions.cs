...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class AuthorizationAppBuilderExtensions
    {
        ...
        private static void VerifyServicesRegistered(IApplicationBuilder app)
        {
            ...
            {
                throw new InvalidOperationException($"Unable to find the required services. Please add all the required services by calling '{nameof(IServiceCollection)}.{nameof(PolicyServiceCollectionExtensions.AddAuthorization)}' inside the call to '{"ConfigureServices(...)"}' in the application startup code.");
            }
        }
    }
}
