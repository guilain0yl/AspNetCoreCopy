    ...
    public static class UseMiddlewareExtensions
    {
        ...
        public static IApplicationBuilder UseMiddleware(this IApplicationBuilder app, Type middleware, params object[] args)
        {
            if (typeof(IMiddleware).GetTypeInfo().IsAssignableFrom(middleware.GetTypeInfo()))
            {
                ...
                if (args.Length > 0)
                {
                    throw new NotSupportedException($"Types that implement '{typeof(IMiddleware)}' do not support explicit arguments.");
                }
            ...
            return app.Use(next =>
            {
                ...
                {
                    throw new InvalidOperationException($"The '{InvokeMethodName}' or '{InvokeAsyncMethodName}' method's first argument must be of type '{nameof(HttpContext)}'.");
                }
            ...
            return app.Use(next =>
            {
                return async context =>
                {
                    ...
                    if (middlewareFactory == null)
                    {
                        ...
                        throw new InvalidOperationException($"No service for type '{typeof(IMiddlewareFactory)}' has been registered.");
                    }
                    ...
                    if (middleware == null)
                    {
                        ...
                        throw new InvalidOperationException($"'{middlewareFactory.GetType()}' failed to create middleware of type '{middlewareType}'.");
                    }
