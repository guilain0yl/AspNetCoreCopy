...
namespace Microsoft.AspNetCore.Routing.Matching
{
    internal sealed class DefaultEndpointSelector : EndpointSelector
    {
        ...
        private static void ReportAmbiguity(CandidateState[] candidateState)
        {
            ...
            var message = $"The request matched multiple endpoints. Matches: {Environment.NewLine}{Environment.NewLine}{string.Join(Environment.NewLine, matches.Select(e => e.DisplayName))}";
