...
namespace Microsoft.AspNetCore.Builder
{
    ...
    public static class RoutingBuilderExtensions
    {
        ...
        public static IApplicationBuilder UseRouter(this IApplicationBuilder builder, IRouter router)
        {
            ...
            {
                throw new InvalidOperationException($"Unable to find the required services. Please add all the required services by calling '{nameof(IServiceCollection)}.{nameof(RoutingServiceCollectionExtensions.AddRouting)}' inside the call to '{"ConfigureServices(...)"}' in the application startup code.");
            }
