...
namespace Microsoft.AspNetCore.Routing.Patterns
{
    internal static class RoutePatternParser
    {
        ...
        private static bool ParseParameter(Context context, List<RoutePatternPart> parts)
        {
            ...
            if (text == "{}")
            {
                context.Error = $"The route parameter name '{string.Empty}' is invalid. Route parameter names must be non-empty and cannot contain these characters: '{{', '}}', '/'. The '?' character marks a parameter as optional, and can occur only at the end of the parameter. The '*' character marks a parameter as catch-all, and can occur only at the start of the parameter.";
                return false;
            }
