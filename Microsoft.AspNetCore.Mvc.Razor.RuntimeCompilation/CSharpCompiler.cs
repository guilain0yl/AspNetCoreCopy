            ...
            else
            {
                ...
                switch (dependencyContextOptions.DebugType.ToLower())
                {
                    ...
                    case "pdbonly":
                        ...
                        break;
                    default:
                        throw new InvalidOperationException($"The debug type specified in the dependency context could be parsed. The debug type value '{dependencyContextOptions.DebugType}' is not supported.");
                }
            }
