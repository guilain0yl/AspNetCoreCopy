...
namespace Microsoft.AspNetCore.Cors.Infrastructure
{
    ...
    public class CorsPolicyBuilder
    {
        ...
        public CorsPolicy Build()
        {
            ...
            {
                throw new InvalidOperationException("The CORS protocol does not allow specifying a wildcard (any) origin and credentials at the same time. Configure the CORS policy by listing individual origins if credentials needs to be supported.");
            }
