...
namespace Microsoft.AspNetCore.Cryptography
{
    internal unsafe static class CryptoUtil
    {
        ...
        public static void AssertPlatformIsWindows()
        {
            ...
            {
                throw new PlatformNotSupportedException("This operation requires Windows 7 / Windows Server 2008 R2 or later.");
            }
        }
        ...
        public static void AssertPlatformIsWindows8OrLater()
        {
            ...
            {
                throw new PlatformNotSupportedException("This operation requires Windows 8 / Windows Server 2012 or later.");
            }
        }
