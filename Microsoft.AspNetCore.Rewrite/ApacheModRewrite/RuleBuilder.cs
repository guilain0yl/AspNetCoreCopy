...
namespace Microsoft.AspNetCore.Rewrite.ApacheModRewrite
{
    internal class RuleBuilder
    {
            ...
            Flags flags)
        {
            ...
            {
                throw new NotSupportedException("Error adding a mod_rewrite rule. The change environment flag is not supported.");
            }
            ...
            else
            {
                ...
                if (flags.GetValue(FlagType.Redirect, out statusCode))
                {
                    ...
                    {
                        throw new FormatException($"Cannot parse '{statusCode}' to integer at string index: '{-1}'");
                    }
