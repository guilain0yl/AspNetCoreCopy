...
namespace Microsoft.AspNetCore.Rewrite.ApacheModRewrite
{
    ...
    internal class ConditionPatternParser
    {
        ...
        public ParsedModRewriteInput ParseActionCondition(string condition)
        {
            ...
            if (!context.Next())
            {
                throw new FormatException($"Unrecognized parameter type: '{condition}', terminated at string index: '{context.Index}'");
            }
        ...
        private static ParsedModRewriteInput ParseProperty(ParserContext context, bool invert)
        {
            if (!context.Next())
            {
                throw new FormatException($"Unrecognized parameter type: '{context.Template}', terminated at string index: '{context.Index}'");
            }
