    ...
    internal static class ServerVariables
    {
        ...
        public static PatternSegment FindServerVariable(string serverVariable, ParserContext context)
        {
            switch (serverVariable)
            {
                ...
                case "AUTH_TYPE":
                    throw new NotSupportedException($"Rules using the '{serverVariable}' server variable are not supported");
                ...
                case "PATH_INFO":
                    throw new NotImplementedException($"Rules using the '{serverVariable}' server variable are not supported");
                case "QUERY_STRING":
                ...
                case "THE_REQUEST":
                    throw new NotSupportedException($"Rules using the '{serverVariable}' server variable are not supported");
                default:
                    throw new FormatException($"Unrecognized parameter type: '{serverVariable}', terminated at string index: '{context.Index}'");
            }
        }
    }
}
